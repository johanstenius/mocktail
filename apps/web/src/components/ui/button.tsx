...
const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--glow-violet)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-void)] disabled:pointer-events-none disabled:opacity-50",
	{
		variants: {
			variant: {
				default:
					"bg-[var(--glow-violet)] text-[var(--text-primary)] border border-white/10 hover:shadow-[0_0_20px_rgba(139,92,246,0.4)] hover:brightness-90 hover:-translate-y-0.5",
				secondary:
				...
				outline:
					"border border-[var(--border-subtle)] text-[var(--text-secondary)] hover:bg-[var(--bg-surface-hover)] hover:border-[var(--border-highlight)] hover:text-[var(--text-primary)]",
				destructive:
